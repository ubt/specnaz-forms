  ...
  return (
    <main style={{ 
      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{ 
            ...
            Проверка работоспособности системы и подключения к Notion API
          </p>
          <a 
            href="/diagnostic" 
            style={{
      ...
      <div style={{
        ...
        <strong>⚠️ Важно:</strong> Перед началом работы обязательно запустите диагностику для проверки настроек системы.
      </div>
    </main>
  );
}