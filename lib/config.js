...
export const CONFIG = {
  ...
  BATCH: {
    ...
    DEFAULT_BATCH_SIZE: 40,   // УМЕНЬШЕНО: Размер батча по умолчанию (< 50 subrequests)
    MAX_BATCH_SIZE: 45,       // УМЕНЬШЕНО: Максимальный размер батча
  ...
  DIRECT_PROCESSING: {
    MAX_OPERATIONS: 40,       // УМЕНЬШЕНО: Максимум операций для прямой обработки
