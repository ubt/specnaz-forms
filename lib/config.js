...
export const CONFIG = {
  ...
  BATCH: {
    ...
    DEFAULT_BATCH_SIZE: 20,   // Размер батча по умолчанию (оптимально для worker'а)
    MAX_BATCH_SIZE: 40,       // Максимальный размер батча (безопасно для worker'а)
    MAX_CONCURRENCY: 1,       // Максимум параллельных запросов
    DEFAULT_CONCURRENCY: 1,   // Параллельность по умолчанию
  ...
  PAGINATION: {
    ...
    MAX_PAGES: 25,            // Максимум страниц для загрузки
  },
