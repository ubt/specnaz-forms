...
// Сбрасываем счетчик запросов периодически
if (typeof globalThis !== 'undefined' && typeof globalThis.setInterval === 'function') {
  globalThis.setInterval(() => {
    requestCount = 0;
    console.log('[RATE LIMIT] Request counter reset');
  }, RESET_INTERVAL);
}
...
export default {
  ...
  detectCommentProp,
  batchUpdateScores
};(`[EVALUATEES] Filter ${i + 1} (${_debugFieldName}) failed:`, individualError.message);
        }
      }
    }
